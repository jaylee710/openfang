//! Shared error types for the OMTAE system.

use thiserror::Error;

/// Top-level error type for the OMTAE system.
#[derive(Error, Debug)]
pub enum OMTAEError {
...
/// Alias for Result with OMTAEError.
pub type OMTAEResult<T> = Result<T, OMTAEError>;
